...
public class InventoryDatabase : MonoBehaviour {
    ...
    void ConstructItemDatabase()
    {
        ...
        {
            database.Add(new Item((int)itemData[i]["id"], itemData[i]["title"].ToString(), (int)itemData[i]["value"], itemData[i]["stats"]["type"].ToString(), 
                (int)itemData[i]["stats"]["power"], float.Parse(itemData[i]["stats"]["range"].ToString()), float.Parse(itemData[i]["stats"]["range"].ToString()), 
                itemData[i]["description"].ToString(), itemData[i]["rarity"].ToString(), (bool)itemData[i]["stackable"], itemData[i]["slug"].ToString()));
